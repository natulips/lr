...
$integration
    ...
    ->addProvider(new \Leadrock\Providers\Leadrock('5202', '371893e3c9eca5808f5ee4ea0050784e'))
    ->setWebmasterLink('https://leadrock.com?track_url=URL-DC307-AB72A')
    ->setThankyouPage('thankyou.php')
    ->setFormField('user_name', 'name')
    ->setFormField('user_phone', 'phone')
    ->setFormField('other', 'other')
    ->addFormValidator()
    ->addFacebookPixel((new \Leadrock\Items\FacebookPixel('11111111111111111111'))->setEvent('PageView'))
    ->disableProxy()
;
